...
/// <FileName> UpdateCommand.cs  </FileName>
...
/// <summary>
/// The purpose of this file is to call the view models update metho.
/// </summary>
...
namespace B_FGMS.BusinessLogic.Commands
{
    public class UpdateCommand : CommandBase
    {
        ...
        public UpdateCommand(ViewModelBase viewModel)
        {
            _viewModel = viewModel;
        }

        /// <summary>
        /// Calls the view models update function to update the selected item.
        /// </summary>
        ...
        public override void Execute(object? parameter)
        {
            ...
            {
                _viewModel.ActionFailed("Failed to update record. Please contact support if issue persists.", "Error");
            }
        }
    }
}
